...
public class GenericModelPaginatorTest extends UnitTest {
    ...
    @Test
    public void testMultipleDatabaseSupport() {
        AltDbMockModel model = new AltDbMockModel();
        model.testKey = "altdbtest";
        model.testValue = "success?";
        model.save();
        ModelPaginator paginator = new ModelPaginator(AltDbMockModel.class);
